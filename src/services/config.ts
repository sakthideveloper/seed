...
export class ConfigService {
	...
	*/
	...
	constructor(
		...
		this.settings = {
			'version': 1,
			'url': 'https://seedbh.com/',//'https://wplms.io/',
			'client_id': '1AmtNxmKZgs0VVPYBKVYcw2', //9gWLZgmn45Es4cjoAUPopRX
		...
		this.configfirebase = {
			apiKey: "AIzaSyDB16R2a_0AQcTsJbqIcMF0ihyteQm6cuQ",
			authDomain: "seedapp-8262f.firebaseapp.com",
			projectId: "seedapp-8262f",
			storageBucket: "seedapp-8262f.appspot.com",
			messagingSenderId: "386393536249",
			appId: "1:386393536249:web:04d2db8b1fc6cd792b5428"
		};
			...
			'sites': [
				...
				},
				{
					...
					'all_settings': {
						'settings': {
							'version': 1,
							'url': 'https://lms.hedayacenter.com/',
